'use strict';
var _require$plugins =


    require('pretty-format').plugins;
const ReactElement = _require$plugins.ReactElement, ReactTestComponent = _require$plugins.ReactTestComponent,
    AsymmetricMatcher = _require$plugins.AsymmetricMatcher, HTMLElement = _require$plugins.HTMLElement,
...
const NO_DIFF_MESSAGE = _require2.NO_DIFF_MESSAGE, SIMILAR_MESSAGE = _require2.SIMILAR_MESSAGE;
const PLUGINS = [
    ReactTestComponent,
    ReactElement,
    AsymmetricMatcher,
    HTMLElement].concat(Immutable);
